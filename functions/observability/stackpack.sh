...
#   cluster_name
# Examples:
#   observability_delete_kubernetes_stackpack demo https://obs.suse.com/ xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx
#######################################
observability_delete_kubernetes_stackpack() {
...
# Examples:
#   observability_check_kubernetes_stackpack demo https://obs.suse.com/ xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx
#######################################
observability_check_kubernetes_stackpack() {
  local cluster_name=$1
  local url=$2
  local service_token=$3
...
#   cluster_name
# Examples:
#   observability_install_kubernetes_stackpack demo https://obs.suse.com/ xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx
#######################################
observability_install_kubernetes_stackpack() {
  local cluster_name=$1
  local url=$2
  local service_token=$3
...
# Examples:
#   observability_kubernetes_stackpack_status demo https://obs.suse.com/ xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx
#######################################
observability_kubernetes_stackpack_status() {
  local cluster_name=$1
  local url=$2
  local service_token=$3
